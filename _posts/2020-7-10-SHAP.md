...
Using independence assumption, we can define mapping function as follow: For presen (1) features, map them to the correspond feature of x. For absent (0) features, sample a data instance y and map them to the correspond feature of y.<br/>
